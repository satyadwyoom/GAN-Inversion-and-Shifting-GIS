...
data_loader_train = DataLoader(train_dataset, batch_size = 1, shuffle=True, num_workers = numofworkers, drop_last=True)
...
_, _, u, _, _ = next(iter(data_loader_train))
...
torch.save(all_user_pref, 'raw_data_exp/preference_score_64.pt')
torch.save(base_user_pref, 'raw_data_exp/base_preference_score_64.pt')
torch.save(base_gen_images, 'raw_data_exp/base_images_64.pt')
torch.save(shifted_images, 'raw_data_exp/shifted_images_64.pt')

# torch.save(all_user_pref, 'raw_data_exp/preference_score_U.pt')
# torch.save(base_user_pref, 'raw_data_exp/base_preference_score_U.pt')
# torch.save(base_gen_images, 'raw_data_exp/base_images_U.pt')
# torch.save(shifted_images, 'raw_data_exp/shifted_images_U.pt')
