...
# torch.save(all_user_pref, 'raw_data_exp/preference_score_U_up.pt')
# torch.save(base_user_pref, 'raw_data_exp/base_preference_score_U_up.pt')
# torch.save(item_user_pref, 'raw_data_exp/item_preference_score_U_up.pt')
# torch.save(base_gen_images, 'raw_data_exp/base_images_U_up.pt')
# torch.save(item_images, 'raw_data_exp/item_images_U_up.pt')
# torch.save(shifted_images, 'raw_data_exp/shifted_images_U_up.pt')

torch.save(all_user_pref, 'raw_data_exp/preference_score_U_p_class2.pt')
torch.save(base_user_pref, 'raw_data_exp/base_preference_score_U_p_class2.pt')
torch.save(item_user_pref, 'raw_data_exp/item_preference_score_U_p_class2.pt')
torch.save(base_gen_images, 'raw_data_exp/base_images_U_p_class2.pt')
torch.save(item_images, 'raw_data_exp/item_images_U_p_class2.pt')
torch.save(shifted_images, 'raw_data_exp/shifted_images_U_p_class2.pt')
